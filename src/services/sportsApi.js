...
// Dicionário de tradução de nomes de seleções/times (Copa do Mundo e outros)
...
function parseEspnEvent(event, leagueId, leagueInfo) {
  ...
  return {
    ...
    leagueId,
    homeTeam:      translateTeamName(homeComp.team?.displayName || homeComp.team?.name || ""),
    awayTeam:      translateTeamName(awayComp.team?.displayName || awayComp.team?.name || ""),
